...
const Items = () => {
  ...
  return (
    <section
      id="menu"
      className="w-full h-fit bg-slate-950 px-12 lg:px-20 py-20 flex flex-col justify-center items-center gap-10"
    >
      <h1
        data-aos="zoom-in"
      ...
      >
        ...
        incidunt nobis inventore qui nemo. Aperiam iusto animi iure, cumque
        eligendi officia ex repellat quas quae magni libero, eveniet eius
        ducimus.
      </p>
      ...
      >
        <div
          data-aos="slide-up"
          data-aos-delay="200"
          className="flex flex-col justify-center items-center gap-4 bg-slate-900 pd-10 lg:w-2/5 w-full rounded-[150px]"
        >
          ...
          <div className="w-full flex flex-col justify-center items-center gap-4 px-10">
            ...
            <p className="text-white font-semibold text-lg text-center">
              ...
              Excepturi in molestiae aut libero magnam neque eius, autem
              accusantium et. Ullam delectus optio vitae rem, saepe placeat illo
              repellat fugit exercitationem!
            </p>
