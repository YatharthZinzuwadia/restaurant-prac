    ...
    <>
      ...
      <div className="w-full bg-black p-4 flex flex-col justify-center items-center text-white font-semibold">
        <h1 className="text-center">
          Copyright 2024, Designed and Developed by yoKi. | All Rights Reserved
        </h1>
        <div
          // data-aos="zoom-in"
          id="icon-box"
          className="bg-orange-500 p-2 rounded-full hover:bg-green-500 cursor-pointer fixed bottom-12 right-6"
        >
          <Link to="home" spy={true} offset={-100} smooth={true}>
            <img src={toparrow} alt="top icon" width={35} height={35} />
          </Link>
        </div>
      </div>
    </>
