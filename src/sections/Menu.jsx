    ...
    <>
      <section className="w-full bg-slate-950 h-fit px-20 py-28 flex flex-col lg:flex-row justify-center items-center gap-16">
        <div
          data-aos="slide-up"
          data-aos-delay="200"
          className="flex justify-center items-center bg-center bg-cover lg:h-[350px] lf:w-[300px] h-[300px] w-[200px] rounded-xl"
      ...
      >
        ...
        >
          <h1 data-aos="zoom-in" className="text-white text-6xl font-cold">
          ...
          >
            ...
            Consectetur consequuntur neque perspiciatis blanditiis odio quas
            excepturi ipsam quibusdam amet omnis libero, tempore officiis
            molestias nihil harum, quos, quae aperiam iure?
          </p>
          <p
            data-aos="zoom-in"
            className="text-white text-xl font-semibold text-center lg:text-start"
